...
API_HASH = environ.get("API_HASH", "27152769")
API_ID = int(environ.get("API_ID", "b98dff566803b43b3c3120eec537fc1d"))
...
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002446190606"))
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002446190606"))
